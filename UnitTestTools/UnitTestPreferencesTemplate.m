...
function UnitTestPreferencesTemplate
    ...
    p = struct(...
            ...
            'alternateFullDataDir',  '/home/ben/Dropbox/ISETBIOFullValidationData', ...          % Alternate FULL data directory location. Specify '' to use the default location, i.e., $validationRootDir/data/full
